!(function () {
  ...
  function i(t) {
    ...
    return u[t].call(e.exports, e, e.exports, i), (e.l = !0), e.exports;
  }
  var t =
    ((n = {}),
    (i.m = u =
      [
        ...
        function (t, e, u) {
          ...
          (T.prototype.create_flags = function (t, e) {
            ...
            return (
              t &&
                ((u = t.indentation_level),
                !this._output.just_added_newline() &&
                  t.line_indent_level > u &&
                  (u = t.line_indent_level)),
              {
                mode: e,
                parent: t,
            ...
            (T.prototype.handle_whitespace_and_comments = function (t, e) {
              var u = t.newlines,
                n = this._options.keep_array_indentation && O(this._flags.mode);
              ...
              if (n)
                for (var _ = 0; _ < u; _ += 1) this.print_newline(0 < _, e);
              else if (
                (this._options.max_preserve_newlines &&
                  u > this._options.max_preserve_newlines &&
                  (u = this._options.max_preserve_newlines),
          ...
          (T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
            (e = void 0 !== e && e),
              this._output.just_added_newline() ||
                ...
                (l(this._flags.last_token.text, h) || l(t.text, h)) &&
                  ((t =
                    (l(this._flags.last_token.text, h) &&
                      l(this._options.operator_position, b)) ||
                    l(t.text, h)),
                  (e = e && t)),
                e
            ...
            (T.prototype.start_of_statement = function (t) {
              return (
                !!(
                  (f(this._flags.last_token, ["var", "let", "const"]) &&
                    t.type === p.WORD) ||
                  a(this._flags.last_token, "do") ||
                  (!(this._flags.parent.mode === k && this._flags.mode === m) &&
                    f(this._flags.last_token, A) &&
                    !t.newlines) ||
                  (a(this._flags.last_token, "else") &&
                    !(a(t, "if") && !t.comments_before)) ||
                ...
                this._flags.last_token.type === p.RESERVED
                  ? "for" === this._flags.last_token.text
                    ...
                    : "import" === this._flags.last_token.text &&
                      "" === t.whitespace_before
                    ? (this._output.space_before_token = !1)
                    : (!l(this._flags.last_token.text, r) &&
                  ...
                  ? ((this._output.space_before_token = !1),
                    ...
                    this._options.space_after_named_function &&
                      e &&
                      ((u = this._tokens.peek(-4)),
                      f(e, ["async", "function"]) ||
                      ("*" === e.text && f(u, ["async", "function"]))
                        ? (this._output.space_before_token = !0)
                        : this._flags.mode === k &&
                          (("{" !== e.text &&
                            "," !== e.text &&
            ...
            (T.prototype.handle_start_block = function (t) {
              ...
              this._flags.last_token.type === p.END_EXPR
                ...
                : u &&
                  ((l(u.text, [":", ","]) &&
                    l(e.type, [p.STRING, p.WORD, p.RESERVED])) ||
                    (l(e.text, ["get", "set", "..."]) &&
                      l(u.type, [p.WORD, p.RESERVED])))
              ...
              if (this._options.brace_preserve_inline) {
                ...
                do {
                  if (((n += 1), (i = this._tokens.peek(n - 1)).newlines)) {
                    this._flags.inline_frame = !1;
                    break;
                  }
                } while (
                  i.type !== p.EOF &&
                  (i.type !== p.END_BLOCK || i.opened !== t)
                );
              }
            ...
            (T.prototype.handle_end_block = function (t) {
              ...
              this._flags.inline_frame && !e
                ...
                : e ||
                  (O(this._flags.mode) && this._options.keep_array_indentation
            ...
            (T.prototype.handle_word = function (t) {
              if (
                (t.type === p.RESERVED &&
                  ((l(t.text, ["set", "get"]) && this._flags.mode !== k) ||
                    ("import" === t.text && "(" === this._tokens.peek().text) ||
                ...
                return (
                  ...
                  this._flags.last_token.type === p.WORD
                    ? f(this._flags.last_token, [
                      ...
                      f(this._flags.last_token, A) ||
                      (a(this._flags.last_token, "default") &&
                    ...
                    ? (this._output.space_before_token = !0)
                    : (!this._flags.multiline_frame &&
                        (R(this._flags.mode) || O(this._flags.mode))) ||
                      this.print_newline(),
                  this.print_token(t),
              ...
              this._flags.last_token.type === p.END_BLOCK
                ...
                : this._flags.last_token.type === p.SEMICOLON &&
                  this._flags.mode === g
                ? (e = "NEWLINE")
                : this._flags.last_token.type === p.SEMICOLON &&
                  R(this._flags.mode)
                ...
                !t.previous ||
                  (t.previous.type !== p.WORD &&
                    t.previous.type !== p.RESERVED) ||
                  (this._output.space_before_token = !0),
                this.print_token(t),
                  ...
                  ? (R(this._flags.parent.mode) &&
                    ...
                    this._flags.declaration_assignment
                      ...
                      : this._options.comma_first &&
                        this.allow_wrap_or_preserved_newline(t))
                  : this._flags.mode === k ||
                    (this._flags.mode === m && this._flags.parent.mode === k)
            ...
            (T.prototype.handle_operator = function (t) {
              var e =
                  "*" === t.text &&
                  (f(this._flags.last_token, ["function", "yield"]) ||
                    l(this._flags.last_token.type, [
                      p.START_BLOCK,
                      p.COMMA,
                      p.END_BLOCK,
              ...
              if (
                (this.start_of_statement(t) ||
                  ((a = !e), this.handle_whitespace_and_comments(t, a)),
                f(this._flags.last_token, c))
              )
                return (
                  (this._output.space_before_token = !0),
                ...
                if ("::" !== t.text) {
                  if (
                    ...
                    return (
                      ...
                      void (this._tokens.peek().type !== p.START_BLOCK
                  ...
                  if (
                    ...
                    switch (this._options.operator_position) {
                      ...
                      case d.preserve_newline:
                        return (
                          _ || this.allow_wrap_or_preserved_newline(t),
                          (n = !(this._output.just_added_newline() || _)),
                      ...
                      this._flags.last_token.type === p.RESERVED
                        ...
                        : this._flags.last_token.type === p.OPERATOR &&
                          ...
                          l(t.text, ["+", "-"]) &&
                            l(this._flags.last_token.text, ["--", "++"]) &&
                            (i = !0)),
                      ((this._flags.mode !== g || this._flags.inline_frame) &&
                        this._flags.mode !== m) ||
                        ("{" !== this._flags.last_token.text &&
                          ";" !== this._flags.last_token.text) ||
                        this.print_newline()),
            ...
            (T.prototype.handle_block_comment = function (t, e) {
              return this._output.raw
                ...
                : void (o.newline.test(t.text) || t.newlines
                ...
                for (
                  n = (function (t, e) {
                    for (var u = 0; u < t.length; u++)
                      if (t[u].trim().charAt(0) !== e) return !1;
                    return !0;
                  })((_ = _.slice(1)), "*"),
                    i = (function (t, e) {
                      for (var u, n = 0, i = t.length; n < i; n++)
                        if ((u = t[n]) && 0 !== u.indexOf(e)) return !1;
                      return !0;
                    })(_, s),
                  ...
                  n
                    ? (this.print_token_line_indentation(t),
                      this._output.add_token(_[u].replace(/^\s+/g, "")))
                    : i && _[u]
                    ? (this.print_token_line_indentation(t),
                      this._output.add_token(_[u].substring(a)))
                    : (this._output.current_line.set_indent(-1),
        ...
        function (t, e, u) {
          ...
          function i(t, e) {
            var u,
              n = {};
            for (u in (t = _(t))) u !== e && (n[u] = t[u]);
            if (e && t[e]) for (u in t[e]) n[u] = t[e][u];
            return n;
          }
          function _(t) {
            var e,
              u = {};
            for (e in t) u[e.replace(/-/g, "_")] = t[e];
            return u;
          }
          (n.prototype._get_array = function (t, e) {
            ...
            (n.prototype._get_selection = function (t, e, u) {
            ...
            (n.prototype._get_selection_list = function (t, e, u) {
              if (!e || 0 === e.length)
                throw new Error("Selection list cannot be empty.");
              if (((u = u || [e[0]]), !this._is_valid_selection(u, e)))
        ...
        function (t, e, u) {
          ...
          var b,
            ...
            i = function (t, e) {
              ...
              this.__patterns = {
                template: e,
                identifier: e
                  .starting_with(r.identifier)
                  .matching(r.identifierMatch),
                number: t.matching(f),
                punct: t.matching(g),
          ...
          ((i.prototype = new n())._is_comment = function (t) {
            ...
            (i.prototype._is_closing = function (t, e) {
              return (
                (t.type === p.END_BLOCK || t.type === p.END_EXPR) &&
                e &&
                (("]" === t.text && "[" === e.text) ||
                  (")" === t.text && "(" === e.text) ||
                  ("}" === t.text && "{" === e.text))
            ...
            (i.prototype._get_next_token = function (t, e) {
              ...
              return null === u
                ...
                : this._read_non_javascript(u) ||
                    this._read_string(u) ||
                    this._read_word(t) ||
                    this._read_singles(u) ||
                    this._read_comment(u) ||
                    this._read_regexp(u, t) ||
                    this._read_xml(u, t) ||
                ...
                ? ((e = e.replace(r.allLineBreaks, "\n")),
                  ...
                  m.test(e)
                    ? "in" === e || "of" === e
                      ...
                      : this._create_token(p.RESERVED, e)
                    : this._create_token(p.WORD, e))
            ...
            (i.prototype._read_singles = function (t) {
              ...
              return (
                "(" === t || "[" === t
                  ? (e = this._create_token(p.START_EXPR, t))
                  : ")" === t || "]" === t
                  ? (e = this._create_token(p.END_EXPR, t))
                  : "{" === t
                  ? (e = this._create_token(p.START_BLOCK, t))
                  : "}" === t
                  ? (e = this._create_token(p.END_BLOCK, t))
                  : ";" === t
                  ? (e = this._create_token(p.SEMICOLON, t))
                  : "." === t && d.test(this._input.peek(1))
                  ? (e = this._create_token(p.DOT, t))
                  : "," === t && (e = this._create_token(p.COMMA, t)),
                e && this._input.next(),
                e
              );
            }),
            (i.prototype._read_punctuation = function () {
              ...
              if ("" !== t)
                return "=" === t
                  ? this._create_token(p.EQUALS, t)
                  : "?." === t
                  ? this._create_token(p.DOT, t)
            ...
            (i.prototype._read_non_javascript = function (t) {
              ...
              if ("#" === t) {
                  ...
                  return (
                    "#" === t ||
                      ("[" === this._input.peek() && "]" === this._input.peek(1)
                        ? ((u += "[]"), this._input.next(), this._input.next())
                        : "{" === this._input.peek() &&
                          "}" === this._input.peek(1) &&
                          ((u += "{}"),
                          this._input.next(),
                ...
                if ((e = this.__patterns.html_comment_start.read())) {
                  for (
                    ;
                    this._input.hasNext() && !this._input.testChar(r.newline);

                  )
                    e += this._input.next();
                  return (b = !0), this._create_token(p.COMMENT, e);
                }
              } else if (
                b &&
                "-" === t &&
                ...
                return (b = !1), this._create_token(p.COMMENT, e);
              return null;
            }),
                ...
                "/" === t &&
                  ...
                  "*" === this._input.peek(1)
                    ? ((e = this.__patterns.block_comment.read()),
                      (t = l.get_directives(e)) &&
                        "start" === t.ignore &&
                        (e += l.readIgnored(this._input)),
                      (e = e.replace(r.allLineBreaks, "\n")),
                      ((u = this._create_token(p.BLOCK_COMMENT, e)).directives =
                        t))
                    : "/" === this._input.peek(1) &&
            ...
            (i.prototype._allow_regexp_or_xml = function (t) {
              return (
                ...
                (t.type === p.END_EXPR &&
                  ")" === t.text &&
                  t.opened.previous.type === p.RESERVED &&
            ...
            (i.prototype._read_regexp = function (t, e) {
              if ("/" === t && this._allow_regexp_or_xml(e)) {
                for (
                  var u = this._input.next(), n = !1, i = !1;
                  this._input.hasNext() &&
                  (n || i || this._input.peek() !== t) &&
                  !this._input.testChar(r.newline);
                ...
                if (n) {
                  for (
                    ...
                    var a = !!n[1],
                      o = n[2];
                    if (
                      (!(!!n[n.length - 1] || "![CDATA[" === o.slice(0, 8)) &&
                        (o === i ||
                          (_ &&
                            o.replace(/^{\s+/, "{").replace(/\s+}$/, "}"))) &&
                        (a ? --s : ++s),
                      (u += n[0]),
                      s <= 0)
                    )
        ...
        function (t, e, u) {
          ...
          (i.prototype.restart = function () {
            ...
            (i.prototype.__match = function (t, e) {
              ...
              return !u || (n && t.sticky) || (u.index !== e && (u = null)), u;
            }),
        ...
        function (t, e, u) {
          ...
          (u.prototype.tokenize = function () {
            ...
            for (
              var e = new _(a.START, ""), u = null, n = [], i = new s();
              e.type !== a.EOF;

            ) {
              for (t = this._get_next_token(e, u); this._is_comment(t); )
                i.add(t), (t = this._get_next_token(e, u));
              i.isEmpty() || ((t.comments_before = i), (i = new s())),
                (t.parent = u),
                this._is_opening(t)
                  ? (n.push(u), (u = t))
                  : u &&
                    this._is_closing(t, u) &&
                    (((t.opened = u).closed = t),
                    (u = n.pop()),
                    (t.parent = u)),
                ((t.previous = e).next = t),
        ...
        function (t, e, u) {
          ...
          ((i.prototype = new n()).__set_whitespace_patterns = function (t, e) {
            ...
            (i.prototype.matching = function (t, e) {
              var u = this._create();
              return u.__set_whitespace_patterns(t, e), u._update(), u;
            }),
            ...
            (i.prototype.__split = function (t, e) {
              for (var u = (t.lastIndex = 0), n = [], i = t.exec(e); i; )
                n.push(e.substring(u, i.index)),
                  ...
                  (i = t.exec(e));
              return (
                u < e.length ? n.push(e.substring(u, e.length)) : n.push(""), n
              );
            }),
        ...
        function (t, e, u) {
          ...
          (n.prototype.get_directives = function (t) {
            ...
            for (var u = this.__directive_pattern.exec(t); u; )
              (e[u[1]] = u[2]), (u = this.__directive_pattern.exec(t));
            return e;
          }),
        ...
        function (t, e, u) {
          ...
          ((_.prototype = new n())._create = function () {
            ...
            (_.prototype.read_options = function (t) {
              var e,
                u = this._create();
              for (e in i) u._disabled[e] = -1 === t.templating.indexOf(e);
              return u._update(), u;
            }),
    ...
    (i.c = n),
    (i.d = function (t, e, u) {
      i.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: u });
    }),
    (i.r = function (t) {
