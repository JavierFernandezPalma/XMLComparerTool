...
const { createErrorLog, updateErrorLog, getErrorLog, deleteErrorLog } = require('../schemas/errorSchema'); // Esquemas de validación
...
router.get('/', 
    ...
    try {
        ...
        const { statusCode, result } = await service.findAll();
